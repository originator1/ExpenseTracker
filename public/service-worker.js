...
self.addEventListener("fetch", function (evt) {
  ...
  //when offline i need to cache value and name of transaction to indexedDb
  //so when back online can access indexedDb and grab object array and PUT to mongodb